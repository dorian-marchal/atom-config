...
function importSort(code, rawParser, rawStyle, file) {
    let parser;
    let style;
...
function sortImports(code, parser, style, file) {
    const items = addFallback(style, file)(StyleAPI_1.default);
...
function addFallback(style, file) {
    return styleApi => {
        const items = [
            { separator: true },
